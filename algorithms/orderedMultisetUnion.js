...
console.log('res', orderedMultisetUnion(nums1A, nums1B));
console.log('ex', expected1);
console.log('res', orderedMultisetUnion(nums2A, nums2B));
console.log('ex', expected2);
console.log('res', orderedMultisetUnion(nums3A, nums3B));
console.log('ex', expected3);
console.log('res', orderedMultisetUnion(nums4A, nums4B));
console.log('ex', expected4);